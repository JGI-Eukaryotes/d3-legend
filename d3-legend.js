...
function color() {
  ...
  function legend(svg) {
    ...
    if (orient === "vertical") {
      ...
      cellTrans = function cellTrans(d, i) {
        var width = (0, _d3Array.sum)(_cellSize2.slice(0, i));
        return "translate(" + (width + i * shapePadding) + ",0)";
      };
